...
public class AllDataTypesInJava {
	...
	public AllDataTypesInJava() {
		...
		/*
		    Output:
		    min value of 'byte' is  ::==> -128 and max value is 127
			min value of 'short' is  ::==> -32768 and max value is 32767
			min value of 'int' is  ::==> -2147483648 and max value is 2147483647
			min value of 'long' is  ::==> -9223372036854775808 and max value is 9223372036854775807
			min value of 'float' is  ::==> 1.4E-45 and max value is 3.4028235E38
			min value of 'double' is  ::==> 4.9E-324 and max value is 1.7976931348623157E308
			min value of 'byte' is  ::==> 
		*/
		...
		*/
		...
		System.out.println("Integer is incremented "+ ++intVariable);
